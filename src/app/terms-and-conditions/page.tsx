...
import { ArrowLeft, Mail, Scale, Info, AlertTriangle, ShieldCheck } from "lucide-react";

export const metadata = {
  title: "Terms and Conditions | ZICA Pitampura",
  description: "Read the Terms and Conditions for Zee Institute of Creative Art (ZICA) Pitampura.",
};
    ...
    <div className="min-h-screen bg-[#030008] text-white font-sans selection:bg-red-600/30 selection:text-white">
      ...
      <main className="relative z-10 max-w-4xl mx-auto px-6 py-12 lg:py-20">
        ...
        <div className="mt-16 space-y-12 text-sm leading-relaxed text-gray-300">
              ...
              <div className="grid gap-4 mt-6">
                {[
                  ...
                  },
                  {
                    ...
                    definition: "mean these Terms and Conditions (also referred as “Terms”) that form the entire agreement between You and the Company regarding the use of the Service.",
                  },
                  {
          ...
          {/* Section 2 */}
          <section id="acknowledgments" className="space-y-6 scroll-mt-24">
            <h2 className="text-2xl font-black uppercase tracking-tight text-white border-l-4 border-red-600 pl-4">
              Acknowledgment
            </h2>
            <p>
          ...
          {/* Section 3 */}
          <section id="links-to-other-sites" className="space-y-6 scroll-mt-24">
            <h2 className="text-2xl font-black uppercase tracking-tight text-white border-l-4 border-red-600 pl-4">
          ...
          {/* Section 4 */}
          <section id="termination" className="space-y-6 scroll-mt-24">
            <h2 className="text-2xl font-black uppercase tracking-tight text-white border-l-4 border-red-600 pl-4">
              Termination
            </h2>
            <p>
          ...
          {/* Section 5 */}
          <section id="limitation-of-liability" className="space-y-6 scroll-mt-24">
            <h2 className="text-2xl font-black uppercase tracking-tight text-white border-l-4 border-red-600 pl-4">
          ...
          {/* Section 6 */}
          <section id="disclaimer" className="space-y-6 scroll-mt-24">
            <h2 className="text-2xl font-black uppercase tracking-tight text-white border-l-4 border-red-600 pl-4">
          ...
          {/* Section 7 */}
          <section id="governing-law" className="space-y-6 scroll-mt-24">
            <h2 className="text-2xl font-black uppercase tracking-tight text-white border-l-4 border-red-600 pl-4">
              Governing Law
            </h2>
            <p>
          ...
          {/* Section 8 */}
          <section id="disputes" className="space-y-6 scroll-mt-24">
            <h2 className="text-2xl font-black uppercase tracking-tight text-white border-l-4 border-red-600 pl-4">
              Disputes Resolution
            </h2>
            <p>
          ...
          {/* Section 9 */}
          <section id="eu-users" className="space-y-6 scroll-mt-24">
            <h2 className="text-2xl font-black uppercase tracking-tight text-white border-l-4 border-red-600 pl-4">
          ...
          {/* Section 10 */}
          <section id="us-legal" className="space-y-6 scroll-mt-24">
            <h2 className="text-2xl font-black uppercase tracking-tight text-white border-l-4 border-red-600 pl-4">
          ...
          {/* Section 11 */}
          <section id="severability-waiver" className="space-y-6 scroll-mt-24">
            <h2 className="text-2xl font-black uppercase tracking-tight text-white border-l-4 border-red-600 pl-4">
              Severability and Waiver
            </h2>
            
            <div className="space-y-4">
              <h3 className="text-lg font-bold text-white uppercase tracking-wider">Severability</h3>
              <p>
            ...
            <div className="space-y-4">
              <h3 className="text-lg font-bold text-white uppercase tracking-wider">Waiver</h3>
              <p>
          ...
          {/* Section 12 */}
          <section id="translation" className="space-y-6 scroll-mt-24">
            <h2 className="text-2xl font-black uppercase tracking-tight text-white border-l-4 border-red-600 pl-4">
          ...
          {/* Section 13 */}
          <section id="changes" className="space-y-6 scroll-mt-24">
            <h2 className="text-2xl font-black uppercase tracking-tight text-white border-l-4 border-red-600 pl-4">
      ...
      <footer className="border-t border-white/10 mt-20 py-8 text-center text-gray-500 text-xs font-semibold uppercase tracking-wider relative z-10 bg-black/40">
        <div className="max-w-7xl mx-auto px-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex gap-4">
            ...
            <Link href="/terms-and-conditions" className="hover:text-white text-white transition-colors">Terms and Conditions</Link>
          </div>
        </div>
      </footer>
    </div>
